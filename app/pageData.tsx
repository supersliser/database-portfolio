...
export default function PageData({ projects, activeProject }: { projects: project[], activeProject: number }) {
    ...
    return <ul key={"ef u"} style={{ display: "flex", flexDirection: "column", justifyContent: "start", alignItems: "start", gap: "1rem", position: "relative", top: "0%", marginTop: "15%", left: "35%", width: "65%", height: "85%", backgroundColor: "rgba(0, 0, 0, 0.0)", backgroundAttachment: "fixed", marginBottom: "5rem", overflow: "auto"}}>
