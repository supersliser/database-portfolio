...
export default function ProjectList({projects, activeProject, setActiveProject}: {projects: project[], activeProject: number, setActiveProject: any}) {
    ...
    return <ul onTouchMove={handleScroll} onWheel={handleScroll} style={{ zIndex: -10, width: "100%", minHeight: "100%", backgroundAttachment: "fixed", backgroundImage: "linear-gradient(to right, rgba(19, 17, 33, 1) 40%, rgba(19, 17, 33, 0))", position: "absolute", top: 0, left: 0 }}>{output}</ul>;
}
